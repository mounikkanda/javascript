var margin={top:20, bottom:165, left:150, right:50},
   ...
   var horizontal=d3.scale.ordinal().rangeRoundBands([0,width],0.3), // moves to new band scale padding
   vertical=d3.scale.linear().rangeRound([height,0]);
   var color = d3.scale.category10();
   var xAxis=d3.svg.axis()                          // Generates x axis
   .scale(horizontal)                               // axisScale
   ...
   d3.json("../js/json/Countries1.json",function(err,data){
